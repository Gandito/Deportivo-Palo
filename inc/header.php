    ...
    <ul class="header_menu_horizontal">
        ...
        <li class="header_rojo">
            ...
            <ul class="header_menu_vertical">
                ...
                <li><a href="socios.php#ancla_hacetesocio">Hacete Socio</a></li>
            </ul>
        </li>
        <li class="header_verde header_uno_verde">
    ...
    <section class="header_nav_seccion_superior">
        <div class="header_contenedor_seccion_responsivo">
            ...
            <div class="header_contenedor_links">
                <ul>
                    <li><a class="header_cerrar_menu1" href="club.php#ancla_datos">Datos</a></li>
                    <li><a class="header_cerrar_menu2" href="club.php#ancla_historia">Historia</a></li>
                </ul>
            </div>
        </div>
        <div class="header_contenedor_seccion_responsivo">
            ...
            <div class="header_contenedor_links">
                <ul>
                    <li><a class="header_cerrar_menu1" href="futbol_plantel.php">Plantel</a></li>
                    <li><a class="header_cerrar_menu2" href="futbol.php#ancla_fixture">Fixture</a></li>
                    <li><a class="header_cerrar_menu3" href="futbol.php#ancla_torneo">Torneo</a></li>
                    <li><a class="header_cerrar_menu4" href="futbol.php#ancla_titulos">Titulos</a></li>
                </ul>
            </div>
        </div>
        <div class="header_contenedor_seccion_responsivo">
        ...
        <div class="header_contenedor_seccion_responsivo">
            ...
            <div class="header_contenedor_links">
                <ul>
                    <li><a class="header_cerrar_menu1" href="socios.php#ancla_informacion">Informacion</a></li>
                    <li><a class="header_cerrar_menu2" href="socios.php#ancla_valores">Valores</a></li>
                    <li><a class="header_cerrar_menu3" href="socios.php#ancla_preguntas">Preguntas</a></li>
                    <li><a class="header_cerrar_menu4" href="socios.php#ancla_hacetesocio">Hacete Socio</a></li>
                </ul>
            </div>
        </div>
        <div class="header_contenedor_seccion_responsivo">
            ...
            <div class="header_contenedor_links">
                <ul>
                    <li><a class="header_cerrar_menu1" href="marketing.php">Marketing</a></li>
                </ul>
            </div>
        </div>
        <div class="header_contenedor_seccion_responsivo">
            ...
            <div class="header_contenedor_links">
                <ul>
                    <li><a class="header_cerrar_menu1" href="canticos.php">Temas</a></li>
                </ul>
            </div>
        </div>
    </section>
